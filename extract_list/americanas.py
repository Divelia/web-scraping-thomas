    ...
    try:
        try:
            WebDriverWait(driver, 10).until(
                EC.presence_of_element_located(
                    (
                        By.XPATH,
                        '//div[@class="src__Container-sc-82ugau-0 fkBfxf"]//ul/li[last()]//button[@class="src__PageButton-sc-82ugau-3 fhogRv"]',
                    )
                )
            )
            ...
            list_of_products = driver.find_elements(
                By.XPATH,
                '//div[contains(@class, "grid__StyledGrid-sc-1man2hx-0 iFeuoP")]/div',
            )
        except:
        ...
        for product in list_of_products:
            try:
                title = product.find_element_by_xpath(
                    './/span[@class="src__Text-sc-154pg0p-0 src__Name-sc-1k0ejj6-4 kpvRnK"]'
                ).text
            except:
                title = ""
            ...
            try:
                price = product.find_element_by_xpath(
                    './/span[@class="src__Text-sc-154pg0p-0 src__PromotionalPrice-sc-1k0ejj6-8 gxxqGt"]'
                ).text
            except:
                price = ""
            ...
            try:
                oldprice = product.find_element_by_xpath(
                    './/span[@class="src__Text-sc-154pg0p-0 src__Price-sc-1k0ejj6-7 dvVMTs"]'
                ).text
            except:
                oldprice = ""
            ...
            try:
                image = product.find_element_by_xpath(
                    './/picture[@class="src__Picture-xr9q25-2 fYTOXR"]/img'
                ).get_attribute("src")
            except:
                image = ""
            ...
            try:
                promo = product.find_element_by_xpath(
                    './/span[@class="src__PaymentDetails-sc-1k0ejj6-3 src__Installment-sc-1k0ejj6-4 hLXDbj"]'
                ).text
            except:
                promo = ""
            ...
            try:
                stock = product.find_element_by_xpath(
                    './/span[@class="src__Count-r5o9d7-1 izzoCr"]'
                ).text
            except:
                stock = ""
        ...
        if df_previous.empty:
            ...
            df_all_rows.to_excel(
                "outputs//americanas-{}.xlsx".format(search), index=False
            )
